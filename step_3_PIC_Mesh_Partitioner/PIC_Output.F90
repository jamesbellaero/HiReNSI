...
!                                                                                                                                                  ++
! Description: THIS Module PRINTS THE OUTPUT OF MESH PARTIIONING for each rank.                                                                    ++
!                                                                                                                                                  ++
...
! - Writing down the input data for each process ----------------------------------------------------------------------------------------------------
  Do IParts = 1, NParts ;
    ...
    ! Coordinate file (.XYZ)
    UnFile = Un_OutXYZ ;
    Open ( Unit = UnFile, FILE = TRIM(ModelName)//'_'//Trim(AdjustL(IndexSize))//'_'//Trim(AdjustL(IndexRank))//'.XYZ', ERR =  1001, IOSTAT = IO_File, ACCESS = 'SEQUENTIAL', ACTION ='Write', ASYNCHRONOUS = 'NO', BLANK = 'NULL', BLOCKSIZE = 0, DEFAULTFILE = TRIM(OutDir), DisPOSE = 'KEEP', FORM = 'FORMATTED', POSITION = 'ASIS', STATUS ='REPLACE') ;

    ! Connectivity file (.Cnn)
    UnFile = Un_OutCnn ;
    Open ( Unit = UnFile, FILE = TRIM(ModelName)//'_'//Trim(AdjustL(IndexSize))//'_'//Trim(AdjustL(IndexRank))//'.Cnn', ERR =  1001, IOSTAT = IO_File, ACCESS = 'SEQUENTIAL', ACTION ='Write', ASYNCHRONOUS = 'NO', BLANK = 'NULL', BLOCKSIZE = 0, DEFAULTFILE = TRIM(OutDir), DisPOSE = 'KEEP', FORM = 'FORMATTED', POSITION = 'ASIS', STATUS ='REPLACE') ;

    ! Constraint file (.Cnt)
    UnFile = Un_OutCnt ;
    Open ( Unit = UnFile, FILE = TRIM(ModelName)//'_'//Trim(AdjustL(IndexSize))//'_'//Trim(AdjustL(IndexRank))//'.Cnt', ERR =  1001, IOSTAT = IO_File, ACCESS = 'SEQUENTIAL', ACTION ='Write', ASYNCHRONOUS = 'NO', BLANK = 'NULL', BLOCKSIZE = 0, DEFAULTFILE = TRIM(OutDir), DisPOSE = 'KEEP', FORM = 'FORMATTED', POSITION = 'ASIS', STATUS ='REPLACE') ;
    ...
    UnFile = Un_OutApp ;
    Open ( Unit = UnFile, FILE = TRIM(ModelName)//'_'//Trim(AdjustL(IndexSize))//'_'//Trim(AdjustL(IndexRank))//'.App', ERR =  1001, IOSTAT = IO_File, ACCESS = 'SEQUENTIAL', ACTION ='Write', ASYNCHRONOUS = 'NO', BLANK = 'NULL', BLOCKSIZE = 0, DEFAULTFILE = TRIM(OutDir), DisPOSE = 'KEEP', FORM = 'FORMATTED', POSITION = 'ASIS', STATUS ='REPLACE') ;

    ! Application Ordering file (.Mat)
    UnFile = Un_OutMat ;
...
!      End Do ;
    ...
    UnFile = Un_OutXYZ ;
      DO K = 1, NJ ;
        If ( Local_PETSc_Num ( K, IParts ) /= 0_Lng ) Then ; !?? check the oreintation 
          Write (Unit = UnFile, FMT = "(<NDim>(E31.23E3,2X) )", ADVANCE = 'YES', ASYNCHRONOUS = 'NO',                 IOSTAT = IO_Write, ERR = 1006 )( XYZ ( K, J ), J = 1, NDim ) ; 
        End If ;
      End Do ;
      ...
      DO IEL = 1, NEL ;
        ...
        If ( EPart ( IEL ) == IParts ) Then ;
          EType = ElT ( IEl ) ; ! Element Type
            ...
            ! determinig NNode for this element     !?? see if all elements included here
            ...
            Else If ( EType == SEl3d27NSld  ) Then ;  NNode = 27;     ! 27 node -3D - Solid
          ...
          Write (Unit = UnFile, FMT = "(<MaxNNode>(I19,2X),I5,2X,I5,2X,I5)", ADVANCE = 'YES', ASYNCHRONOUS = 'NO',                 IOSTAT = IO_Write, ERR = 1006 ) ( Local_PETSc_Num ( INOD ( I, IEL ), IParts ), I = 1, NNode ), (I*0, I = 1, MaxNNode - NNode ), MTEL ( IEL ), ELT ( IEL ), ELGR ( IEL ) ;
        End If ;
    ...
    ! Writing the Local Equation Numbers (Local ID)
      Do IJ = 1, NJ_Rank ( IParts ) ;
        Write (Unit = UnFile, FMT = "(<NDOF>(I19,2X) )", ADVANCE = 'YES', ASYNCHRONOUS = 'NO',                 IOSTAT = IO_Write, ERR = 1006 ) ( ID_Local ( IJ, INode ), INode = 1, NDOF ) ;
      End Do ;
...
!      End Do ;
    ...
    Write (Unit = UnFile, FMT = "(<NEqM_Mapping>(I19,2X),'Application Numbering')", ADVANCE = 'YES', ASYNCHRONOUS = 'NO',                 IOSTAT = IO_Write, ERR = 1006 ) ( App_Numbers   ( I ), I = 1, NEqM_Mapping ) ;
    Write (Unit = UnFile, FMT = "(<NEqM_Mapping>(I19,2X),'PETSc Numbering'      )", ADVANCE = 'YES', ASYNCHRONOUS = 'NO',                 IOSTAT = IO_Write, ERR = 1006 ) ( PETSc_Numbers ( I ), I = 1, NEqM_Mapping ) ;
    Write (Unit = UnFile, FMT = "(<NEQM>(I19,2X),'Local To Global Numbering'    )", ADVANCE = 'YES', ASYNCHRONOUS = 'NO',                 IOSTAT = IO_Write, ERR = 1006 ) ( Indices       ( I ), I = 1, NEQM ) ;
