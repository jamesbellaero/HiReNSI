...
Integer (Kind=Tiny)  :: NInt ;                   ! Number of Integration points for Gauss Quadrature integration method
Integer (Kind=Tiny)  :: NInt_Type ;              ! Type of Integration points.  1: Using exact relations  2: Using numerical representations  3: Guass Points for Triangle Elements  4: Guass Points for Tetrahedra Elements
Integer (Kind=Tiny)  :: NDim ;                   ! Number of Dimensions
Integer (Kind=Tiny)  :: MaxNNode ;               ! MaxNumber of Nodes of elements in the model (in case we different element types in one model)
Integer (Kind=Tiny)  :: SOLVER_Type ;            ! Solver Type, 1: Iterative solver - 2: super LU direct solver
Integer (Kind=Tiny)  :: Int_Order ;              ! Order of Quadrature - INtegration

! Smll Integers
Integer (Kind=Smll)  :: Iyr, Imon, Iday ;        ! Date variables
Integer (Kind=Smll)  :: Ih, Im, Is, I100th ;     ! Time variables
Integer (Kind=Smll)  :: IO_File ;                ! Used for IOSTAT - Input Output Status - in the OPEN cammand.
Integer (Kind=Smll)  :: ERR_Alloc, ERR_DeAlloc ; ! Allocating and DeAllocating errors
Integer (Kind=Smll)  :: UnFile ;                 ! Holds Unit of a file for error message
Integer (Kind=Smll)  :: NAT ;                    ! Number of Analysis Type
Integer (Kind=Smll)  :: NGroup ;                 ! Number of GROUPs of model
Integer (Kind=Smll)  :: NPM ;                    ! Numnber of properties of materials
Integer (Kind=Smll)  :: NMat ;                   ! Number of materials
Integer (Kind=Smll)  :: NLCase ;                 ! Number of load cases

! Shrt Integers
Integer (Kind=Shrt)  :: COUNT, COUNT_RATE, COUNT_MAX ;                        ! TIME Variables  !?? check this @@@@@@@@@@@@@@@@@@@
...
Integer (Kind=Lng )  :: NEQM ;                   ! Modified Number of Equatoins
Integer (Kind=Lng )  :: I ;                      ! Loop index
...
! Tiny Integers
Integer (Kind=Tiny),              Dimension(5)   :: LoadC ;          ! Load Case, Indicates which kinds of static load should be consider in analysis (1 2 3 4) - 1: body force - 2: pressure - 3: concentrated force - 4: specified Displacements - 5: Static/Dynaimc analysis/both: 0/1/2
...
! - Character Variables -----------------------------------------------------------------------------------------------------------------------------
Character (Kind = 1, Len = 50 ) :: ModelName ;   ! name of the model input file
Character (Kind = 1, Len = 50 ) :: AnaName ;     ! Name of the analysis input file
Character (Kind = 1, Len = 200) :: Model_InDir ;! Directory of Model input file.
Character (Kind = 1, Len = 250) :: Ana_InDir ;   ! Directory of Analysis input file.
Character (Kind = 1, Len = 250) :: InlDir ;      ! Directory of internal files.
Character (Kind = 1, Len = 250) :: OutDir ;      ! Directory of output files (Results)
