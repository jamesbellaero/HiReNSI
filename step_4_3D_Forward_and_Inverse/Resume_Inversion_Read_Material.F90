...
! Comment: we record material properties at every 10 iterations, at two different files: Iter 10 (1) - 20 (2) - 30 (1) - 40 (2) - 50 (1) - 60 (2) ...
   ...
   If ( Mod ( Iter_begin-1 , 10 ) /= 0 ) Then
      Write (*,*) 'Inversion can only be resumed at iterations 11, 21, 31, .... Change Iter_begin.'
      Stop
   End If

   Iter_File_10 = Mod ( Iter_begin-1 , 10 )
   Iter_File_20 = Mod ( Iter_begin-1 , 20 )
